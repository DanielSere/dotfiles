...
alias logout='((sleep 1; loginctl kill-user kino) & bspc quit)'
# Commands
alias sudoers='sudo nvim /etc/sudoers.d/wheel'
alias edit-grub='sudo nvim /etc/default/grub'
alias up-grub='sudo update-grub'
alias polybar='pkill polybar; sleep 1; polybar -q main -c /home/kino/.config/polybar/config.ini &'
alias xdgninja='~/.local/bin/xdg-ninja/xdg-ninja.sh'
alias lf='~/.config/lf/lf || ~/.config/lf/lf'
alias ssh-gen='ssh-keygen -t rsa -b 4069 -C'
alias ftp5871='lftp kino@192.168.58.71:2121'
